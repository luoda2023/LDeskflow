...
This document provides a comprehensive reference for the LDeskflow network protocol. It is the primary source of information for developers implementing LDeskflow clients or extending the protocol.

## Protocol Overview

The LDeskflow protocol enables keyboard and mouse sharing between multiple computers over a TCP network connection. The protocol uses two distinct sets of terminology to describe the roles of the computers involved:
...
- **Protocol Logs**: Enable verbose logging in LDeskflow
